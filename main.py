...
trivia_bot = TriviaBot(discord_bot_token=my_discord_bot_token, openai_api_key=my_openai_api_key, trivia_channel_id=trivia_channel_id, general_channel_id=general_channel_id)
